...
namespace VsFullCleanup.Logger
{
   ...
   public interface ILogger
   {
      ...
      void LogException(LoggingLevel level, [Localizable(false)] string message, Exception exception);
      ...
      void Log(LoggingLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, params object[] args);
      ...
      /// <param name="message">A <see langword="string" /> containing format items.</param>
      /// <param name="args">Arguments to format.</param>
      void Log(LoggingLevel level, [Localizable(false)] string message, params object[] args);
      ...
      void Log<TArgument>(LoggingLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument argument);
      ...
      /// <param name="message">A <see langword="string" /> containing one format item.</param>
      /// <param name="argument">The argument to format.</param>
      void Log<TArgument>(LoggingLevel level, [Localizable(false)] string message, TArgument argument);
      ...
      void Log<TArgument1, TArgument2>(LoggingLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2);
      ...
      /// <param name="argument1">The first argument to format.</param>
      /// <param name="argument2">The second argument to format.</param>
      void Log<TArgument1, TArgument2>(LoggingLevel level, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2);
      ...
      void Log<TArgument1, TArgument2, TArgument3>(LoggingLevel level, IFormatProvider formatProvider, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3);
      ...
      /// <param name="argument2">The second argument to format.</param>
      /// <param name="argument3">The third argument to format.</param>
      void Log<TArgument1, TArgument2, TArgument3>(LoggingLevel level, [Localizable(false)] string message, TArgument1 argument1, TArgument2 argument2, TArgument3 argument3);
